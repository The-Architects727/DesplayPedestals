...
public class IndestructableAltarDisplayTile extends BaseTile {

    private ItemStack cachedItem;

    public IndestructableAltarDisplayTile(BlockPos pos, BlockState state) {
        super(ItemDisplay.RegistryEvents.INDESTRUCTABLE_ALTAR_DISPLAY_TYPE.get(), pos, state);
