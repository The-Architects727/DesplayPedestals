...
public class AltarDisplayTile extends BaseTile {

    private ItemStack cachedItem;

    public AltarDisplayTile(BlockPos pos, BlockState state) {
        super(ItemDisplay.RegistryEvents.ALTAR_DISPLAY_TYPE.get(), pos, state);
