...
@OnlyIn(Dist.CLIENT)
public class TESRAltarDisplay implements BlockEntityRenderer<AltarDisplayTile> {

    public TESRAltarDisplay(BlockEntityRendererProvider.Context dispatcher) {
    }

    public void renderItem(AltarDisplayTile tile, ItemStack stack, float partialTicks, PoseStack matrix, MultiBufferSource buffer, int combinedLight, int combinedOverlay) {
...
//            matrix.scale(0.6F, 0.6F, 0.6F);
    ...
    @Override
    public void render(AltarDisplayTile tile, float partialTicks, PoseStack matrix, MultiBufferSource buffer, int combinedLight, int combinedOverlay) {
    ...
    @Override
    public boolean shouldRenderOffScreen(AltarDisplayTile p_112306_) {
        return true;
    }
